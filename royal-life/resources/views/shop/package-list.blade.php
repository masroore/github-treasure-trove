                        ...
                        <table class="table nowrap scroll-horizontal-vertical myTable table-striped">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    <td> @if($service->img == null)
                                        <img class="o"
                                         src="{{asset('assets/img/home/producto21.png')}}"
                                         alt="Product Image"
                                         style=" width: 100px; height: 100px;">
                                         @else
                                         <img src="{{ asset('storage/photo-producto/'.$service->img) }}" alt="" height="100" width="100">
                                        @endif

                                    </td>

                                    <td>{{$service->name}}</td>
                                    <td>{{$service->getCategories->categories_name}}</td>
                                   {{--       <td>{{$service->minimum_deposit}}</td>--}}

                                    <td>{{$service->price}}</td>
                                    <td>{{$service->precio_rebajado}}</td>
                                    <td>
