...
class SendAppendNotificationHandler
{
     ...
     * Handle the thread.
     */
    public function handle(AppendEventInterface $event): void
    {
     ...
     * Trigger the thread.
     */
    protected function trigger(Append &$append): void
    {
        $this->newAppendNotify($append);
    }

    private function newAppendNotify(Append $append): void
    {
