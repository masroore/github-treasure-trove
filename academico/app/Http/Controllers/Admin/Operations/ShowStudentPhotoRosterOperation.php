...
trait ShowStudentPhotoRosterOperation
{
     ...
     */
    protected function setupShowStudentPhotoRosterRoutes($segment, $routeName, $controller): void
    {
     ...
     */
    protected function setupShowStudentPhotoRosterDefaults(): void
    {
        $this->crud->allowAccess('showstudentphotoroster');
        $this->crud->setOperationSetting('setFromDb', true);

        $this->crud->operation('showstudentphotoroster', function (): void {
