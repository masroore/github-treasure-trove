 ...
 * @property mixed $partnerships
 * @property mixed $year_distinct_students_count
 * @property \App\Models\Period[]|\Illuminate\Database\Eloquent\Collection $periods
 * @property null|int $periods_count
 *
