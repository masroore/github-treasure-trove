 ...
 *
 * @property int $id
 * @property null|string $hired_at
 * @property null|string $max_week_hours
 ...
 * @property mixed $name
 * @property mixed $upcoming_leaves
 * @property \App\Models\Leave[]|\Illuminate\Database\Eloquent\Collection $leaves
 * @property null|int $leaves_count
 * @property \App\Models\RemoteEvent[]|\Illuminate\Database\Eloquent\Collection $remote_events
