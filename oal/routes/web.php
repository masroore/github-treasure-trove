...
Route::group(['middleware' => ['auth', 'verified', 'admin_check', 'set_view_variables']], function (): void {
...
Route::group(['middleware' => ['auth', 'verified', 'subcription_check', 'set_view_variables']], function (): void {
