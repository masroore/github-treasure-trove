...
class User extends Authenticatable
{
    ...
    public function updateInvestmentNo(): void
    {
        Setting::find(1)->increment('investment_no');

    }

    public function updateInvestmentNoDraft(): void
    {
        Setting::find(1)->increment('investment_draft_no');

    }

    public function sendOtp($to, $msg): void
    {
    ...
    public function notificationSave($sender_user_id, $receiver_user_id, $link, $message): void
    {
        $requestData2 = [];
