...
class Controller extends BaseController
{
    ...
    protected function getCryptocurrencyList()
    {
        ...
        for ($i = 0; $i < count($cryptocurrency_list); ++$i) {
            ...
            } elseif ($cryptocurrency_list[$i]['currency'] == 'WIZ+') {
                $cryptocurrency_list[$i]['ico'] = asset('/icons/wiz+.svg');
            } elseif ($cryptocurrency_list[$i]['currency'] == '8CO') {
                $cryptocurrency_list[$i]['ico'] = asset('/icons/8co.png');
            } elseif ($cryptocurrency_list[$i]['currency'] == 'JCC') {
