...
class Vender extends Authenticatable
{
    ...
    public function billChartData()
    {
        ...
        $progressData['unpaidPr'] = (0 != $totalBill) ? ($totalUnpaidBill * 100) / $totalBill : 0;
        $progressData['paidPr'] = (0 != $totalBill) ? ($totalPaidBill * 100) / $totalBill : 0;
        $progressData['partialPr'] = (0 != $totalBill) ? ($totalPartialBill * 100) / $totalBill : 0;
        $progressData['duePr'] = (0 != $totalBill) ? ($totalDueBill * 100) / $totalBill : 0;
    ...
    {
        return Bill::where('vender_id', $vendorId)->orderBy('bill_date', 'desc')->get();
    }
    ...
    {
        return Bill::where('vender_id', $vendorId)->count();
    }
}
