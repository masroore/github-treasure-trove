                ...
                <div class="col-lg-4 col-md-4">
                 ...
                 <div class="col-lg-4 col-md-4">
                    <div class="form-group">
                        ...
                        <div class="form-icon-user">
                            <!--<span><i class="fas fa-joint"></i></span>-->
                            {{ Form::select('vouchertype', array('JV' => 'Journal Voucher', 'BPV' => 'Bank payment Voucher', 'CPV' => 'Cash payment Voucher', 'BR' => 'Bank Receipt' , 'CR' => 'Cash Receipt'), 'JV', array('class' => 'form-control','required'=>'required'))  }}
