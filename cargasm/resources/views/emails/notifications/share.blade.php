                                        ...
                                        <tr>
                                            <td valign="top" align="left" style="margin:0;padding:0">
                                                    ...
                                                    <span class="letter-user"
                                                        ...
                                                        {{trans('notification.mail_text')}} <a href="{{config('services.frontUrl')}}"
                                                      ...
                                                      style="line-height:22px;display:block;padding-right:0px;padding-bottom:0;padding-left:0px;font-family:Arial,sans-serif;color:#333333;font-size:16px;font-weight:normal;">
                                                        <b>{{$user->nickname}}</b>
                                                         @if($entity instanceof \App\Models\Event)
                                                            {{trans('notification.event.share.body')}}
                                                            <q><strong>{{$entity->title}}</strong></q>

                                                        @elseif($entity instanceof \App\Models\Post)
                                                            {{trans('notification.blog.share.body')}}
                                                            <q><strong>{{$entity->title}}</strong></q>

                                                        @elseif($entity instanceof \App\Models\Photo)
                                                            {{trans('notification.photo.share.body')}}
                                                            <q><strong>{{$entity->title}}</strong></q>
...
{{--                                                        Если у вас не получилось нажать на кнопку «Подтвердить»--}}
{{--                                                        скопируйте ссылку ниже и вставьте в поисковую строку своего--}}
{{--                                                        браузера--}}
{{--                                                        <a href="#"--}}
                    ...
                    <td align="left" valign="top" class="letter-content"
                        ...
                        <span
                            style="margin-top:15px;text-align:left;line-height:18px;display:block;padding-right:0px;padding-top:0px;padding-left:0px;font-family:Arial,sans-serif;color:#999999;font-size:12px;font-weight:normal;">
                                Copyright © 2018 Cargasm.club Все права защищены.
                            </span>
                    </td>
                </tr>
@endsection
