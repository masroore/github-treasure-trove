...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-articleSuivantArticles">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.article.fields.langue') }}
                        </th>
                        <th>
                            {{ trans('cruds.article.fields.titre') }}
                        </th>
                        <th>
                            {{ trans('cruds.article.fields.sous_category') }}
                        </th>
                        <th>
                            {{ trans('cruds.article.fields.types') }}
                        </th>
                        <th>
                            {{ trans('cruds.article.fields.site') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($articles as $key => $article)
                        <tr data-entry-id="{{ $article->id }}">
                            ...
                            <td>
                                {{ App\Models\Article::LANGUE_SELECT[$article->langue] ?? '' }}
                            </td>
                            <td>
                                {{ $article->titre ?? '' }}
                            </td>
                            <td>
                                {{ $article->sous_category->nom_fr ?? '' }}
                            </td>
                            <td>
                            ...
                            <td>
                                {{ App\Models\Article::SITE_SELECT[$article->site] ?? '' }}
                            </td>
                            <td>
                                @can('article_show')
...
@endcan
  ...
  let table = $('.datatable-articleSuivantArticles:not(.ajaxTable)').DataTable({ buttons: dtButtons })
