...
class TravelController extends Controller
{
    ...
    public function store(Request $request)
    {
        if (\Auth::user()->can('Create Travel')) {
            ...
            if (isset($setting['twilio_trip_notification']) && 1 == $setting['twilio_trip_notification']) {
            ...
            if (1 == $setings['employee_trip']) {
                ...
                return redirect()->route('travel.index')->with('success', __('Travel  successfully created.') . ($smtp_error ?? ''));
            }
