...
//            dd(Employee::employeeTotalLeave(1));
    ...
    public function changeaction(Request $request)
    {
        ...
        if (isset($setting['twilio_leave_approve_notification']) && 1 == $setting['twilio_leave_approve_notification']) {
        ...
        if (1 == $setings['leave_status']) {
            ...
            return redirect()->route('leave.index')->with('success', __('Leave status successfully updated.') . ($smtp_error ?? ''));
        }
