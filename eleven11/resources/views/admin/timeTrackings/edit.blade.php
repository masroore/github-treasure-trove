...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.time-trackings.update", [$timeTracking->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('checkin_time') ? 'is-invalid' : '' }}" type="text" name="checkin_time" id="checkin_time" value="{{ old('checkin_time', $timeTracking->checkin_time) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('checkout_time') ? 'is-invalid' : '' }}" type="text" name="checkout_time" id="checkout_time" value="{{ old('checkout_time', $timeTracking->checkout_time) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_hours') ? 'is-invalid' : '' }}" type="text" name="total_hours" id="total_hours" value="{{ old('total_hours', $timeTracking->total_hours) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="number" name="status" id="status" value="{{ old('status', $timeTracking->status) }}" step="1" required>
