    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.locations.update", [$location->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('location_code') ? 'is-invalid' : '' }}" type="text" name="location_code" id="location_code" value="{{ old('location_code', $location->location_code) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('street_address') ? 'is-invalid' : '' }}" type="text" name="street_address" id="street_address" value="{{ old('street_address', $location->street_address) }}" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('active') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="active" id="active" value="1" {{ $location->active || old('active', 0) === 1 ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('square_foot') ? 'is-invalid' : '' }}" type="number" name="square_foot" id="square_foot" value="{{ old('square_foot', $location->square_foot) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('annual_budget') ? 'is-invalid' : '' }}" type="number" name="annual_budget" id="annual_budget" value="{{ old('annual_budget', $location->annual_budget) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('call_in_numbers') ? 'is-invalid' : '' }}" type="text" name="call_in_numbers" id="call_in_numbers" value="{{ old('call_in_numbers', $location->call_in_numbers) }}">
