    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.shifts.update", [$shift->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('start_date') ? 'is-invalid' : '' }}" type="text" name="start_date" id="start_date" value="{{ old('start_date', $shift->start_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('end_date') ? 'is-invalid' : '' }}" type="text" name="end_date" id="end_date" value="{{ old('end_date', $shift->end_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('start_time') ? 'is-invalid' : '' }}" type="text" name="start_time" id="start_time" value="{{ old('start_time', $shift->start_time) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('end_time') ? 'is-invalid' : '' }}" type="text" name="end_time" id="end_time" value="{{ old('end_time', $shift->end_time) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('days') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="days" id="days" value="1" {{ $shift->days || old('days', 0) === 1 ? 'checked' : '' }} required>
                    <label class="required form-check-label" for="days">{{ trans('cruds.shift.fields.days') }}</label>
                </div>
                @if($errors->has('days'))
                    <div class="invalid-feedback">
                        {{ $errors->first('days') }}
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('frequency') ? 'is-invalid' : '' }}" name="frequency" id="frequency">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('active') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="active" id="active" value="1" {{ $shift->active || old('active', 0) === 1 ? 'checked' : '' }} required>
                    <label class="required form-check-label" for="active">{{ trans('cruds.shift.fields.active') }}</label>
                </div>
