<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('time_tracking_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.time-trackings.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/time-trackings") || request()->is("admin/time-trackings/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
        ...
        @can('random_code_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.random-codes.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/random-codes") || request()->is("admin/random-codes/*") ? "c-active" : "" }}">
                    <i class="fa-fw fas fa-cogs c-sidebar-nav-icon">
