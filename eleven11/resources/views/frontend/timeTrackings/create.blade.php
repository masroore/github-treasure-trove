    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.time-trackings.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="checkin_time" id="checkin_time" value="{{ old('checkin_time') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="checkout_time" id="checkout_time" value="{{ old('checkout_time') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="total_hours" id="total_hours" value="{{ old('total_hours', '') }}">
