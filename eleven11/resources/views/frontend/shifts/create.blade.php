                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.shifts.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="shift_name" id="shift_name" value="{{ old('shift_name', '') }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                <input type="checkbox" name="days" id="days" value="1" required {{ old('days', 0) == 1 ? 'checked' : '' }}>
