                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.locations.update", [$location->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="location_code" id="location_code" value="{{ old('location_code', $location->location_code) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="location_name" id="location_name" value="{{ old('location_name', $location->location_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="street_address" id="street_address" value="{{ old('street_address', $location->street_address) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="city" id="city" required>
                                ...
                                @foreach(App\Models\Location::CITY_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('city', $location->city) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('city'))
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="state" id="state" required>
                                ...
                                @foreach(App\Models\Location::STATE_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('state', $location->state) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('state'))
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="country" id="country" value="{{ old('country', $location->country) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="zip_code" id="zip_code" value="{{ old('zip_code', $location->zip_code) }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                <input type="checkbox" name="active" id="active" value="1" {{ $location->active || old('active', 0) === 1 ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="latitude" id="latitude" value="{{ old('latitude', $location->latitude) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="longitude" id="longitude" value="{{ old('longitude', $location->longitude) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="company_id" id="company_id" required>
                                @foreach($companies as $id => $company)
                                    <option value="{{ $id }}" {{ (old('company_id') ? old('company_id') : $location->company->id ?? '') == $id ? 'selected' : '' }}>{{ $company }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="square_foot" id="square_foot" value="{{ old('square_foot', $location->square_foot) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="annual_budget" id="annual_budget" value="{{ old('annual_budget', $location->annual_budget) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="call_in_numbers" id="call_in_numbers" value="{{ old('call_in_numbers', $location->call_in_numbers) }}">
