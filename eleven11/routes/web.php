...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth', 'admin']], function (): void {
    ...
    // Time Tracking
    Route::delete('time-trackings/destroy', 'TimeTrackingController@massDestroy')->name('time-trackings.massDestroy');
    Route::resource('time-trackings', 'TimeTrackingController');
    ...
    // Random Code
    Route::delete('random-codes/destroy', 'RandomCodeController@massDestroy')->name('random-codes.massDestroy');
    Route::resource('random-codes', 'RandomCodeController');
...
Route::group(['as' => 'frontend.', 'namespace' => 'Frontend', 'middleware' => ['auth']], function (): void {
