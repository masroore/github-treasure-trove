...
<section class="section">
    <div class="section-header">
        ...
        <h1>{{ __('admin.settings.automation') }}</h1>
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">{{ __('admin.settings.automation') }}</div>
        </div>
    </div>
    ...
    <div class="section-body">
        ...
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-pills flex-column">
                            <li class="nav-item"><a href="{{ route('admin.settings.system.index') }}" class="nav-link">{{ __('admin.settings.system') }}</a></li>
            ...
            <div class="col-md-8">
                ...
                @include('admin.settings.automation.partials.scheduled-tasks')
                <!-- Database Backup Card -->
                @include('admin.settings.automation.partials.database-backup')
                <!-- Laravel Optimization Card -->
                @include('admin.settings.automation.partials.laravel-optimization')
