<div class="col-md-4">
    <div class="card card-primary pull-up" style="border-top: 2px solid @if($site->is_fav) #FC544B @endif">
        <div class="card-header">
            <h4 class="align-items-center">
                <a href="{{ route('vault.site.show', [$vault,$site]) }}" class="font-weight-bold text-decoration-none text-dark">
                    @if($url = $site->getFirstMediaUrl('favicon'))
                        <img class="rounded mr-1" src="{{ $url }}" alt="favicon" style="width: 20px;"/>
                    @else
