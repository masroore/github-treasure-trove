      ...
      <div class="card-body">
        ...
        <form id="createProjectForm">
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-lg-10">
              <input id="projectname" name="job_title" type="text" class="form-control" placeholder="Enter Project Name...">
            </div>
          </div>
          <div class="form-group row mb-4">
          ...
          <div id="hourly_price" class="d-none form-group row mb-4">
          ...
          <div class="form-group row mb-4" id="fixed_price">
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-lg-10">
              <textarea class="form-control" name="job_description" rows="3" placeholder="Enter Project Description..."></textarea>
            </div>
          </div>
        ...
        <div class="row mb-4">
          ...
          <div class="col-lg-10">
            <input name="job_attachement[]" form="createProjectForm" type="file" multiple />
