...
class SampleDataSeeder extends Seeder
{
    ...
    protected function content(): void
    {
        ...
        factory(Thread::class, 50)->states('from_existing_channels_and_users')->create()->each(function ($thread): void {
     ...
     * @param $user_id
     */
    public function recordActivity($model, $event_type, $user_id): void
    {
