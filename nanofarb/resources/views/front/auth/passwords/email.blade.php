    ...
    <div class="personal personal_password personal_login">
        <div class="breadcrumb-repeat">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{ trans('site.Восстановление пароля') }}</li>
            </ol>
        </div>
        <div class="personal__wrapper">
            <h1 class="name-big">{{ trans('site.Восстановление пароля') }}</h1>
            ...
            <form action="{{ route('password.email') }}" method="POST" class="js-ajax-form-submit" data-id="reset-password-form">
                @csrf
                <div class="personal-content">
                    <div class="personal-content__left">
                        ...
                        <div class="personal-content__left-bottom">
                            <button type="submit" class="btn-gen">{{ trans('site.Выслать новый пароль') }}</button>
                        </div>
                    </div>
                </div>
            </form>
