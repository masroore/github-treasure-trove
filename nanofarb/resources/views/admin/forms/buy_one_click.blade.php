...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Список покупателей ({{ $forms->total() }})</h3>
        </div>
        <div class="box-body">
            <div class="table-responsive">
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td>@isset($form->data['product_id']){{ link_to_route('product.show', null, $form->data['product_id'], ['target' => '_blank']) }}@endisset</td>
