...
<div class="row">
    <div class="col-lg-6">
        ...
        <div class="form-group {{ $errors->has('consumption') ? 'has-error' : ''}}">
            {!! Form::label('consumption', 'Расход, кг/м2', ['class' => 'control-label']) !!}
            <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-credit-card"></i></span>
                {!! Form::number('consumption', isset($product) ? $product->consumption : null, ['class' => 'form-control','step' => 0.01]) !!}
            </div>
            {!! $errors->first('consumption', '<p class="help-block">:message</p>') !!}
        </div>
    ...
    <div class="col-lg-6">
        ...
        @include('admin.fields.field-file-uploaded-simple',[
              'label' => 'Техническая спецификация продукта',
