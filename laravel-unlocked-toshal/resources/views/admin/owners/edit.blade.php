					...
					<form action="{{route('owner.update')}}" method="post" class="user" id="edit_user_form" enctype="multipart/form-data">@csrf
						...
						<div class="row">
							...
							<div class="form-group">
									...
									<input type="number" min="0" name="mobile" id="mobile" minlength="10" maxlength="12"  value="{{old('mobile', isset($ownerDetail->user_detail->mobile)?$ownerDetail->user_detail->mobile:"")}}" class="form-control form-control-user" />
						...
						<div class="row">
							<div class="col-lg-4 col-md-6 col-12">
								<div class="form-group">
									...
									<input type="number" min="0" name="zipcode" id="zipcode"  value="{{old('zipcode', isset($ownerDetail->user_detail->zipcode) ? $ownerDetail->user_detail->zipcode:"")}}" class="form-control form-control-user" />
