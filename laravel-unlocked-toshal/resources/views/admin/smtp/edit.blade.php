		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-body pt-2 pb-3 manageClinicSection">
					...
					<form action="{{route('smtp.update')}}" method="post" class="user" id="edit_smtp_form" enctype="multipart/form-data">
						@csrf
						...
						<div class="row">
							<div class="col-lg-4 col-md-6 col-12">
								<div class="form-group">
									...
									<input type="text" name="host" id="host" value="{{old('host', $record->host)}}" class="form-control form-control-user" />
									@if ($errors->has('host'))
							...
							<div class="col-lg-4 col-md-6 col-12">
								<div class="form-group">
									...
									<input type="text" name="port" id="port" value="{{old('port', $record->port)}}" class="form-control form-control-user" />
									@if ($errors->has('port'))
						...
						<div class="row">
							<div class="col-lg-4 col-md-6 col-12">
								<div class="form-group">
									...
									<input type="text" name="username" id="username" value="{{old('username', $record->username)}}" class="form-control form-control-user" />
							...
							<div class="col-lg-4 col-md-6 col-12">
								<div class="form-group">
									...
									<input type="text" name="from_name" id="from_name" value="{{old('from_name', $record->from_name)}}" class="form-control form-control-user" />
						...
						<div class="row">
							<div class="col-lg-4 col-md-6 col-12">
								<div class="form-group">
									...
									<input type="email" name="from_email" id="from_email" value="{{old('from_email', $record->from_email)}}" class="form-control form-control-user" />
							...
							<div class="col-lg-4 col-md-6 col-12">
								<div class="form-group">
									...
									<input type="text" name="password" id="password" value="" class="form-control form-control-user" />
						...
						<div class="row">
							<div class="col-lg-4 col-md-6 col-12">
								<div class="form-group">
									...
									<input type="text" name="encryption" id="encryption" value="{{old('encryption', $record->encryption)}}" class="form-control form-control-user" />
						...
						<div class="mt-1 mb-1">
							<div class="text-left d-print-none mt-4">
								<button type="submit" id="edit-genre-btn" class="btn btn-primary">Update</button>	<a href="{{route('smtp.list')}}" class="btn btn-light">Cancel</a>
							</div>
						</div>
					</form>
				</div>
...
<script>
    $( document ).ready(function() {
    	$("form[id='edit_smtp_form']").validate({
