            ...
            <div class="flex py-0">
              ...
              <div class="flex-1 my-3 px-3">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="title" size=90 value="{{ ' 가나다라 ' .  date('H:i:s') }}" class="border border-indigo-400">
                </div>

                <div class="form-group">
                  <label for="label" class="control-label">영상 링크입력: </label>
                  <input type="text" name="outlink1" size=90 value="https://sendvid.com/embed/cb25p3zw" class="border border-indigo-400">
                </div>
