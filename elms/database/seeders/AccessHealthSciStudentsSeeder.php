...
class AccessHealthSciStudentsSeeder extends Seeder
{
    ...
    {
        if (str_contains($dep, 'Nursing')) {
            return 9;
        }
        if (str_contains($dep, 'Bachelor of Science in Midwifery')) {
            return 10;
        }
        if (str_contains($dep, 'Medical Technology')) {
            return 11;
        }
        if (str_contains($dep, 'Diploma in Midwifery')) {
            return 12;
        }
    }
}
