...
class IsulanStudentsSeeder extends Seeder
{
    ...
    {
        if (str_contains($dep, 'Civil Engineering')) {
            return 14;
        }
        if (str_contains($dep, 'Computer Engineering')) {
            return 15;
        }
        if (str_contains($dep, 'Electronics Engineering')) {
            return 16;
        }
        if (str_contains($dep, 'Computer Science')) {
            return 17;
        }
        if (str_contains($dep, 'Information Technology')) {
            return 18;
        }
        if (str_contains($dep, 'Information Systems')) {
            return 19;
        }
        if (str_contains($dep, 'BTVTE')) {
            return 20;
        }
        if (str_contains($dep, 'BIT-')) {
            return 45;
        }
        if (str_contains($dep, 'BSIT-')) {
            return 45;
        }
    }
