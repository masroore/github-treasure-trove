...
// Student Routes
Route::prefix('student')->middleware(['auth', 'isStudent'])->group(function (): void {
...
// Teacher Routes
Route::prefix('teacher')->middleware(['auth', 'verified', 'isTeacher'])->group(function (): void {
...
// Program Head Routes
Route::prefix('programhead')->middleware(['auth', 'isProgramHead'])->group(function (): void {
...
// Dean Routes
Route::prefix('dean')->middleware(['auth', 'isDean'])->group(function (): void {
