...
class TeacherCoursesPage extends Component
{
    ...
    public function changeQuarter(): void
    {
    ...
    public function setEmail($stud): void
    {
    ...
    public function enrolStudent()
    {
        ...
        if ($u) {
            ...
            return $this->alert('warning', 'Student not found.', ['toast' => false, 'position' => 'center']);
        }
    ...
    public function copyAlert(): void
    {
