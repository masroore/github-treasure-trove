...
class Gradebook extends Component
{
    ...
    public function editDays($editing, $student): void
    {
    ...
    public function saveWeights()
    {
        ...
        if ($sum !== 100) {
            return $this->alert('error', 'The weights should add up to 100!');
        }
    ...
    {
        if ($this->section->ungraded) {
            return $this->confirm('You have ungraded task submissions.', ['timer' => 0, 'toast' => false, 'position' => 'center', 'onConfirmed' => 'confirmed', 'showConfirmButton' => true, 'confirmButtonText' => 'Proceed', 'showCancelButton' => true]);
        }
