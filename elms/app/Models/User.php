...
class User extends Authenticatable
{
    ...
    public function readSupports(): void
    {
    ...
    public function contactMessages($contactId)
    {
        ...
        if ($messages->count()) {
            return $messages->toQuery();
        }

        return collect();
    }

    public function sendMessage($message, $contactId): void
    {
        DB::transaction(function () use ($message, $contactId): void {
            Message::create([
                'sender_id' => Auth::id(),
