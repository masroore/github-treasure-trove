...
if ('POST' == $_SERVER['REQUEST_METHOD']) {
    ...
    $message_form = !empty($submits['message']) ? $submits['message'] : [];
    ...
    $forcerecap = (!empty($submits['force_recaptcha']) && 'false' != $submits['force_recaptcha']) ? true : false;
    ...
    $autores = (!empty($submits['autoresponder']) && 'false' != $submits['autoresponder']) ? true : false;
    ...
    $unsets = ['prefix', 'subject', 'replyto', 'template', 'html_title', 'message', 'autoresponder', 'ar_subject', 'ar_title', 'ar_message', 'ar_footer', $prefix . 'botcheck', 'g-recaptcha-response', 'force_recaptcha', $prefix . 'submit'];
