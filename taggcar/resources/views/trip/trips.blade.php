          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
              <td class="text-center">
                <input type="checkbox" class="checkboxes" name="ID" onclick="clicked();" value="{{ $trip->id }}" />
              </td>
              <td class="text-center">{{$trip->name}}</td>
              <td class="text-center">{{$trip->departure}}</td>
              <td class="text-center">{{$trip->arrival}}</td>
              <td class="text-center">{{$trip->price}}</td>
              <td class="text-center">{{$trip->start_date}}</td>
              <td class="text-center">
                <div class="btn-group-xs">
                  <a href="{{ url('tripDetail/') }}/{{$trip->id}}" class="btn_detail">
                      Detail
                  </a>
