...
class GetSidebarMenu implements MenuInterface
{
    ...
    private function getMenuFromDB($menuId, $menuName, $locale): void
    {
    ...
    private function getGuestMenu($locale, $menuId): void
    {
        $this->getMenuFromDB($menuId, 'guest', $locale);
    }

    private function getUserMenu($locale, $menuId): void
    {
        $this->getMenuFromDB($menuId, 'user', $locale);
    }

    private function getAdminMenu($locale, $menuId): void
    {
