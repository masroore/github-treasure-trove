...
Route::middleware('auth')->group(function (): void {
    ...
    Route::group(['middleware' => ['permission:medias']], function (): void {
    ...
    Route::group(['middleware' => ['permission:permissions.index']], function (): void {
    ...
    Route::group(['middleware' => ['permission:app-settings']], function (): void {
