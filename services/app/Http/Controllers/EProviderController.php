...
class EProviderController extends Controller
{
    ...
    public function __construct(EProviderRepository $eProviderRepo, CustomFieldRepository $customFieldRepo, UploadRepository $uploadRepo, EProviderTypeRepository $eProviderTypeRepo, UserRepository $userRepo, AddressRepository $addressRepo, TaxRepository $taxRepo)
    {
        parent::__construct();
    ...
    public function create()
    {
        ...
        return view('e_providers.create')->with('customFields', $html ?? false)->with('eProviderType', $eProviderType)->with('user', $user)->with('usersSelected', $usersSelected)->with('address', $address)->with('addressesSelected', $addressesSelected)->with('tax', $tax)->with('taxesSelected', $taxesSelected);
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('e_providers.edit')->with('eProvider', $eProvider)->with('customFields', $html ?? false)->with('eProviderType', $eProviderType)->with('user', $user)->with('usersSelected', $usersSelected)->with('address', $address)->with('addressesSelected', $addressesSelected)->with('tax', $tax)->with('taxesSelected', $taxesSelected);
    }
