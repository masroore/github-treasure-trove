...
class GalleryController extends Controller
{
    ...
    public function __construct(GalleryRepository $galleryRepo, CustomFieldRepository $customFieldRepo, UploadRepository $uploadRepo, EProviderRepository $eProviderRepo)
    {
        parent::__construct();
    ...
    public function create()
    {
        ...
        return view('galleries.create')->with('customFields', $html ?? false)->with('eProvider', $eProvider);
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('galleries.edit')->with('gallery', $gallery)->with('customFields', $html ?? false)->with('eProvider', $eProvider);
    }
