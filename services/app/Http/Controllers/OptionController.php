...
class OptionController extends Controller
{
    ...
    public function __construct(OptionRepository $optionRepo, CustomFieldRepository $customFieldRepo, UploadRepository $uploadRepo, EServiceRepository $eServiceRepo, OptionGroupRepository $optionGroupRepo)
    {
        parent::__construct();
