...
class AvailabilityHourController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('availability_hours.create')->with('customFields', $html ?? false)->with('eProvider', $eProvider);
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('availability_hours.edit')->with('availabilityHour', $availabilityHour)->with('customFields', $html ?? false)->with('eProvider', $eProvider);
    }
