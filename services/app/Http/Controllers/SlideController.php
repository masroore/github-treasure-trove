...
class SlideController extends Controller
{
    ...
    public function __construct(SlideRepository $slideRepo, CustomFieldRepository $customFieldRepo, UploadRepository $uploadRepo, EServiceRepository $eServiceRepo, EProviderRepository $eProviderRepo)
    {
        parent::__construct();
    ...
    public function create()
    {
        ...
        return view('slides.create')->with('customFields', $html ?? false)->with('eService', $eService)->with('eProvider', $eProvider);
    }
    ...
    public function edit($id)
    {
        ...
        return view('slides.edit')->with('slide', $slide)->with('customFields', $html ?? false)->with('eService', $eService)->with('eProvider', $eProvider);
    }
