...
class EServiceController extends Controller
{
    ...
    public function __construct(EServiceRepository $eServiceRepo, CustomFieldRepository $customFieldRepo, UploadRepository $uploadRepo, CategoryRepository $categoryRepo, EProviderRepository $eProviderRepo)
    {
        parent::__construct();
    ...
    public function create()
    {
        ...
        return view('e_services.create')->with('customFields', $html ?? false)->with('category', $category)->with('categoriesSelected', $categoriesSelected)->with('eProvider', $eProvider);
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('e_services.edit')->with('eService', $eService)->with('customFields', $html ?? false)->with('category', $category)->with('categoriesSelected', $categoriesSelected)->with('eProvider', $eProvider);
    }
