...
class ExperienceController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('experiences.create')->with('customFields', $html ?? false)->with('eProvider', $eProvider);
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('experiences.edit')->with('experience', $experience)->with('customFields', $html ?? false)->with('eProvider', $eProvider);
    }
