...
class DeliveryAddressController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('delivery_addresses.create')->with('customFields', $html ?? false)->with('user', $user);
    }
    ...
    public function edit($id)
    {
        ...
        return view('delivery_addresses.edit')->with('deliveryAddress', $deliveryAddress)->with('customFields', $html ?? false)->with('user', $user);
    }
