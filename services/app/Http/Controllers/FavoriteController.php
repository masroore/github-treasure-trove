...
class FavoriteController extends Controller
{
    ...
    public function __construct(FavoriteRepository $favoriteRepo, CustomFieldRepository $customFieldRepo, EServiceRepository $eServiceRepo, OptionRepository $optionRepo, UserRepository $userRepo)
    {
        parent::__construct();
