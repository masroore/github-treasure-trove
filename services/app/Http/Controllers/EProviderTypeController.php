...
class EProviderTypeController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('e_provider_types.create')->with('customFields', $html ?? false);
    }
    ...
    public function edit($id)
    {
        ...
        return view('e_provider_types.edit')->with('eProviderType', $eProviderType)->with('customFields', $html ?? false);
    }
