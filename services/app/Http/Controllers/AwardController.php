...
class AwardController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('awards.create')->with('customFields', $html ?? false)->with('eProvider', $eProvider);
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('awards.edit')->with('award', $award)->with('customFields', $html ?? false)->with('eProvider', $eProvider);
    }
