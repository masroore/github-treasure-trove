...
class CouponController extends Controller
{
    ...
    public function __construct(CouponRepository $couponRepo, CustomFieldRepository $customFieldRepo, EServiceRepository $eServiceRepo, EProviderRepository $eProviderRepo, CategoryRepository $categoryRepo, DiscountableRepository $discountableRepository)
    {
        parent::__construct();
    ...
    public function create()
    {
        ...
        return view('coupons.create')->with('customFields', $html ?? false)->with('eService', $eService)->with('eProvider', $eProvider)->with('category', $category)->with('eServicesSelected', $eServicesSelected)->with('eProvidersSelected', $eProvidersSelected)->with('categoriesSelected', $categoriesSelected);
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('coupons.edit')->with('coupon', $coupon)->with('customFields', $html ?? false)->with('eService', $eService)->with('eProvider', $eProvider)->with('category', $category)->with('eServicesSelected', $eServicesSelected)->with('eProvidersSelected', $eProvidersSelected)->with('categoriesSelected', $categoriesSelected);
    }
