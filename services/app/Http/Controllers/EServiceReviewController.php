...
class EServiceReviewController extends Controller
{
    ...
    public function __construct(EServiceReviewRepository $eServiceReviewRepo, CustomFieldRepository $customFieldRepo, UserRepository $userRepo, EServiceRepository $eServiceRepo)
    {
        parent::__construct();
    ...
    public function create()
    {
        ...
        return view('e_service_reviews.create')->with('customFields', $html ?? false)->with('user', $user)->with('eService', $eService);
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('e_service_reviews.edit')->with('eServiceReview', $eServiceReview)->with('customFields', $html ?? false)->with('user', $user)->with('eService', $eService);
    }
