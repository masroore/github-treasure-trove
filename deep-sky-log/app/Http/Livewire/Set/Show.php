...
class Show extends Component
{
    ...
    public function showInstruments(): void
    {
        $this->showInstruments = true;
    }

    public function hideInstruments(): void
    {
        $this->showInstruments = false;
    }

    public function showEyepieces(): void
    {
        $this->showEyepieces = true;
    }

    public function hideEyepieces(): void
    {
    ...
    public function showLenses(): void
    {
        $this->showLenses = true;
    }

    public function hideLenses(): void
    {
        $this->showLenses = false;
    }

    public function adaptTitle(): void
    {
    ...
    public function adaptDescription(): void
    {
        $this->origDescription = $this->set->description;
