...
class Zend_Queue implements Countable
{
     ...
     *
     * @param  null|array|string|Zend_Config|Zend_Queue_Adapter String or adapter instance, or options array or Zend_Config instance
     * @param  array|Zend_Config $options Zend_Config or a configuration array
     */
     ...
     * @param  string           $name
     *
     * @return false|Zend_Queue Provides a fluent interface
     */
