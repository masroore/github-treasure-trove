...
class Zend_Loader
{
     ...
     *                             to search
     */
    public static function loadClass($class, $dirs = null): void
    {
     ...
     */
    public static function registerAutoload($class = 'Zend_Loader', $enabled = true): void
    {
        trigger_error(__CLASS__ . '::' . __METHOD__ . ' is deprecated as of 1.8.0 and will be removed with 2.0.0; use Zend_Loader_Autoloader instead', E_USER_NOTICE);
     ...
     * @param  string $filename
     */
    protected static function _securityCheck($filename): void
    {
        /**
         * Security check.
         */
