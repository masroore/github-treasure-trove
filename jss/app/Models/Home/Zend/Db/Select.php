...
class Zend_Db_Select
{
     ...
     *
     * @return null|string This object as a SELECT string. (or null if a string cannot be produced.)
     */
     ...
     */
    protected function _tableCols($correlationName, $cols, $afterCorrelationName = null): void
    {
        if (!is_array($cols)) {
            $cols = [$cols];
        }
