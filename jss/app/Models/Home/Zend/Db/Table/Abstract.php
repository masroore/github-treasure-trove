...
abstract class Zend_Db_Table_Abstract
{
     ...
     * getDefinition().
     *
     * @return null|Zend_Db_Table_Definition
     */
     ...
     */
    public static function setDefaultAdapter($db = null): void
    {
     ...
     */
    public static function setDefaultMetadataCache($metadataCache = null): void
    {
     ...
     */
    protected function _setupDatabaseAdapter(): void
    {
        if (!$this->_db) {
     ...
     *
     * @param array|string|Zend_Db_Table_Select $where  OPTIONAL An SQL WHERE clause or Zend_Db_Table_Select object
     * @param array|string                      $order  OPTIONAL An SQL ORDER clause
     ...
     *
     * @return null|Zend_Db_Table_Row_Abstract the row results per the
    ...
    public static function getTableFromString($tableName, ?self $referenceTable = null)
    {
