...
class Zend_Log_Writer_Firebug extends Zend_Log_Writer_Abstract
{
     ...
     *
     * @return bool|string The previous logging display style if defined or TRUE otherwise
     */
     ...
     * @param int $priority The logging priority
     *
     * @return bool|string The logging display style if defined or FALSE otherwise
     */
