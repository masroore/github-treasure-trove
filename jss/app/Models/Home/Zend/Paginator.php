...
class Zend_Paginator implements Countable, IteratorAggregate
{
     ...
     * @param string $path
     */
    public static function addAdapterPrefixPath($prefix, $path): void
    {
     ...
     * </code>
     */
    public static function addAdapterPrefixPaths(array $prefixPaths): void
    {
     ...
     * @param string $path
     */
    public static function addScrollingStylePrefixPath($prefix, $path): void
    {
     ...
     * </code>
     */
    public static function addScrollingStylePrefixPaths(array $prefixPaths): void
    {
        if (isset($prefixPaths['prefix'], $prefixPaths['path'])) {
     ...
     * Set a global config.
     */
    public static function setConfig(Zend_Config $config): void
    {
        self::$_config = $config;
     ...
     * @param int $count
     */
    public static function setDefaultItemCountPerPage($count): void
    {
     ...
     * @param int $count
     */
    public static function setDefaultPageRange($count): void
    {
     ...
     * Sets a cache object.
     */
    public static function setCache(Zend_Cache_Core $cache): void
    {
        self::$_cache = $cache;
    }
     ...
     */
    public static function setDefaultScrollingStyle($scrollingStyle = 'Sliding'): void
    {
