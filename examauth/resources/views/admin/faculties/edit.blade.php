    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.faculties.update", [$faculty->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('falculty_name') ? 'is-invalid' : '' }}" type="text" name="falculty_name" id="falculty_name" value="{{ old('falculty_name', $faculty->falculty_name) }}" required>
