...
Route::group(['middleware' => ['log.activity']], function (): void {
    ...
    Route::group(['middleware' => ['auth']], function (): void {
        ...
        Route::group(['prefix' => 'forum'], function (): void {
            // auth forum routes
            // topics
            ...
            Route::group(['middleware' => ['auth.elevated']], function (): void {
        ...
        Route::group(['prefix' => 'user'], function (): void {
            Route::group(['prefix' => 'chat/threads'], function (): void {
                // user messaging
        ...
        Route::group(['prefix' => 'moderator', 'middleware' => ['auth.elevated']], function (): void {
