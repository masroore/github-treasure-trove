...
class User extends Authenticatable
{
     ...
     * @return bool
     */
    public function hasUnreadMessagesFromSender(self $user)
    {
     ...
     */
    public function receivedMessagesFromSender(self $user)
    {
     ...
     * @return int
     */
    public function unreadMessageCountForSender(self $user)
    {
