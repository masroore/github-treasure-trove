...
Route::group(['middleware' => ['web', 'switch_lang']], function (): void {
    ...
    /** End */
    Route::group(['middleware' => ['maintainence_mode']], function (): void {
        ...
        Route::group(['middleware' => ['IsInstalled', 'is_verified', 'isActive', 'two_fa', 'switch_lang']], function (): void {
        ...
        /** Authorized Routes */
        Route::group(['middleware' => ['auth', 'is_verified', 'two_fa', 'switch_lang']], function (): void {
            ...
            Route::group(['middleware' => ['SellerAdminMix']], function (): void {
