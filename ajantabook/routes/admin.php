...
Route::group(['middleware' => ['auth', 'admin_access', 'switch_lang']], function (): void {
    ...
    Route::name('admin.affilate.')->prefix('/admin/affiliate')->group(function (): void {
    ...
    Route::name('admin.pos.')->prefix('/admin/pos')->group(function (): void {
