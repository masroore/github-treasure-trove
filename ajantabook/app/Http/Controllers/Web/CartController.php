...
class CartController extends Controller
{
        ...
        if (!empty($user)) {
            ...
            if ($cart_table) {
                ...
                if (isset(Session::get('coupanapplied')['appliedOn']) && 'cart' == Session::get('coupanapplied')['appliedOn']) {
                    ...
                    // Putting a session//
                    Session::put('coupanapplied', ['code' => $coupon->code, 'cpnid' => $coupon->id, 'discount' => $totaldiscount, 'msg' => "$coupon->code Applied Successfully !", 'appliedOn' => 'cart']);
                } elseif (isset(Session::get('coupanapplied')['appliedOn']) && 'category' == Session::get('coupanapplied')['appliedOn']) {
                    $code = Session::get('coupanapplied')['code'];
        ...
        if (!empty(Session::get('cart'))) {
            ...
            if (1 == $avbl) {
                ...
                if ($tqty <= $limit) {
                    ...
                    } elseif (isset(Session::get('coupanapplied')['appliedOn']) && 'cart' == Session::get('coupanapplied')['appliedOn']) {
                        $pdis = Session::get('coupanapplied');
                        $coupon = Coupan::where('code', '=', Session::get('coupanapplied')['code'])->first();
                        $totaldiscount = Session::get('coupanapplied')['discount'];
                        $total = 0;
    ...
    public function removeitemlogin($id): void
    {
    }
