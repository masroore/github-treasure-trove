...
class UnitController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (isset($findsameval)) {
            if (0 == strcasecmp($request->title, $findsameval->title)) {
    ...
    public function update(Request $request, $id)
    {
        ...
        if (isset($findsameval)) {
            if (0 == strcasecmp($findsameval->title, $request->title) && $unit->id != $findsameval->id) {
    ...
    public function storeValue(Request $request, $id)
    {
        ...
        if (isset($findsameval)) {
            if (0 == strcasecmp($findsameval->unit_values, $request->unit_values)) {
                return back()->with('warning', __('Option already added !'));
            }
        }
    ...
    public function editValue(Request $request, $id)
    {
        ...
        if (isset($findsameval)) {
            if (0 == strcasecmp($findsameval->unit_values, $request->unit_values) && $unitval->id != $findsameval->id) {
                return back()->with('warning', __('Option already there !'));
            }
        }

        if (isset($findshortcode)) {
            if (0 == strcasecmp($findshortcode->short_code, $request->short_code) && $unitval->id != $findshortcode->id) {
