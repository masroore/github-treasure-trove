...
class DetailAdsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ('category' == $request->linkby || 'detail' == $request->linkby || 'url' == $request->linkby) {
