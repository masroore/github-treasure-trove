...
class PinCodController extends Controller
{
        ...
        if ($request->ajax()) {
            return Datatables::of($countries)
                ...
                ->addColumn('view', function ($row) {
                    return '<a title="' . __('Click to view list of cities') . '" href=' . url('/admin/destination/listbycountry/' . $row->id . '/pincode') . ' class="btn btn-primary-rgba btn-sm">View</a>';
                })
    ...
    public function pincode_add(Request $request): void
    {
    ...
    public function import(Request $request)
    {
        ...
        if (\count($pincodefile)) {
            $pincodefile->each(function ($pin): void {
