...
class PreorderController extends Controller
{
    public function payment(Request $request, $id)
    {
        if ($request->hasValidSignature()) {
            ...
            if ('pre_order' == $order->type) {
                Session::put('inv_preorder', $order->id);

                Session::save();

                if ('Instamojo' == $order->order->payment_method) {
                ...
                if ('Paypal' == $order->order->payment_method) {
                ...
                if ('Paytm' == $order->order->payment_method) {
                ...
                if ('Cashfree' == $order->order->payment_method) {
                ...
                if ('PayU' == $order->order->payment_method) {
                ...
                if ('DPO PAYMENT' == $order->order->payment_method && Module::has('DPOPayment') && Module::find('DPOPayment')->isEnabled()) {
