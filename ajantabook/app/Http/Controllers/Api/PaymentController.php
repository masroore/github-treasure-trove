...
class PaymentController extends Controller
{
    ...
    public function confirmOrder(Request $request)
    {
        ...
        foreach ($cart_table2 as $key => $invcart) {
            ...
            $newInvoice->igst = isset($tax) && 'single' == $tax['tax_type'] ? $tax['amount']['amount1'] : null;
            $newInvoice->sgst = isset($tax) && 'multiple' == $tax['tax_type'] ? $tax['amount']['amount1'] : null;
            $newInvoice->cgst = isset($tax) && 'multiple' == $tax['tax_type'] ? $tax['amount']['amount2'] : null;
            ...
            if ('v' == $invcart->product->vender->role_id) {
