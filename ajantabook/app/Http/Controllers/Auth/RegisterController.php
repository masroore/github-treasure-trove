...
class RegisterController extends Controller
{
    ...
    {
        if (1 == $this->setting->captcha_enable) {
            $request->validate(
                [
        ...
        if ($af_system && '1' == $af_system->enable_affilate) {
        ...
        $user = User::create([
            ...
            'email_verified_at' => '1' == $this->setting->email_verify_enable ? null : Carbon::now(),
            'is_verified' => 1,
            'refered_from' => $af_system && '1' == $af_system->enable_affilate ? $request['refer_code'] : null,
        ]);
        ...
        if ($af_system && '1' == $af_system->enable_affilate) {
            $findreferal->getReferals()->create([
                ...
                'procces' => 1 == $af_system->enable_purchase ? 0 : 1,
            ]);

            if (0 == $af_system->enable_purchase) {
                ...
                if (isset($findreferal->wallet) && 1 == $findreferal->wallet->status) {
        ...
        if ('1' == $this->setting->email_verify_enable) {
