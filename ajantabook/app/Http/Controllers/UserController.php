...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ('Seller' == $request->role) {
            $input['role_id'] = 'v';
        } elseif ('Customer' == $request->role) {
            $input['role_id'] = 'c';
        } elseif ('Blocked' == $request->role) {
            $input['role_id'] = 'c';
        } else {
            $input['role_id'] = 'a';
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (isset($request->wallet_status, $user->wallet)) {
    ...
    public function destroy($id)
    {
        ...
        if (null != $user->image && file_exists(public_path() . '/images/user/' . $user->image)) {
            unlink(public_path() . '/images/user/' . $user->image);
        }

        if (1 == $this->wallet_system && isset($user->wallet)) {
