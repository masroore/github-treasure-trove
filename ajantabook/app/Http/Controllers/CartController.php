...
class CartController extends Controller
{
    ...
    public function create_cart()
    {
        ...
        if (1 == $checkoutsetting_check->enable_cart_page) {
        ...
        if (Auth::check()) {
            ...
            foreach ($cart_table as $key => $value) {
                ...
                if (isset($value->variant) && 0 == $value->variant->stock) {
                    $oot[] = 0;
                }

                if (isset($value->simple_product) && 0 == $value->simple_product->stock && 0 == $value->simple_product->pre_order) {
                    $oot[] = 0;
                }
            }
        } else {
            ...
            if ($cart_table) {
                if ($cart_table->variant_id == $variantid) {
                    ...
                    if ($tqty <= $limit) {
                        ...
                        if (isset(Session::get('coupanapplied')['appliedOn']) && 'product' == Session::get('coupanapplied')['appliedOn']) {
                            ...
                            if (isset($coupon)) {
                                if ($coupon->pro_id == $newCart->pro_id) {
                                    if ('per' == $coupon->distype) {
                                        if (0 != $newCart->semi_total) {
                        ...
                        } elseif (Session::has('coupanapplied') && 'category' == Session::get('coupanapplied')['appliedOn']) {
                            $coupon = Coupan::where('code', '=', Session::get('coupanapplied')['code'])->first();
                            $newCart = Cart::where('variant_id', $variantid)->where('user_id', $user->id)
                                ->first();
                            $per = 0;
                        ...
                        } elseif (Session::has('coupanapplied') && 'cart' == Session::get('coupanapplied')['appliedOn']) {
                            $coupon = Coupan::where('code', '=', Session::get('coupanapplied')['code'])->first();
                ...
                if (isset(Session::get('coupanapplied')['appliedOn']) && 'cart' == Session::get('coupanapplied')['appliedOn']) {
        ...
        if (!empty(Session::get('cart'))) {
            ...
            if (1 == $avbl) {
                ...
                if ($tqty <= $limit) {
                    ...
                    if (Session::has('coupanapplied') && 'product' == Session::get('coupanapplied')['appliedOn']) {
                        $totaldiscount = 0;
            ...
            if (Session::has('coupanapplied') && 'cart' == Session::get('coupanapplied')['appliedOn']) {
                $totaldiscount = 0;
    ...
    public function remove_cart($id)
    {
        ...
        if (\count($cart) > 0) {
            if ('product' == Session::get('coupanapplied')['appliedOn']) {
                foreach ($cart as $key => $row) {
                    if ($row['variantid'] == $id) {
                        unset($cart[$key]);
            ...
            if ('category' == Session::get('coupanapplied')['appliedOn']) {
                $notavbl = 1;
                $catcart = collect();
                $totaldiscount = 0;
                $count = 0;
            ...
            if ('cart' == Session::get('coupanapplied')['appliedOn']) {
                $cpn = Coupan::where('code', '=', Session::get('coupanapplied')['code'])->first();
                $totaldiscount = 0;
                $total = 0;
                foreach ($cart as $key => $c) {
    ...
    public function rent_update(Request $request)
    {
        ...
        if (!empty($user_id)) {
            ...
            if ($ca->variant && $ca->product) {
                ...
                if (0 == $offertotal || null == $offertotal || '' == $offertotal) {
            ...
            foreach ($show_cart_table as $key => $val) {
                if (null == $val->semi_total || 0 == $val->semi_total) {
        ...
        if (!empty($auth)) {
            ...
            foreach ($cart_table as $key => $cart) {
                if (isset($cart->product) && 0 == $cart->product->free_shipping) {
                    ...
                    if (!empty($free_shipping)) {
                        if ('Shipping Price' == $free_shipping->name) {
                            ...
                            if (1 == get_default_shipping()->whole_order) {
        ...
        if (Auth::check()) {
            ...
            if (isset($ca->variant) && 0 == $ca->variant->products->free_shipping) {
        ...
        if (!Auth::check() && !Session::has('coupanapplied')) {
            $per = 0;
        } elseif (Auth::check() && '1' == Cart::isCoupanApplied()) {
            ...
            } elseif ('category' == Session::get('coupanapplied')['appliedOn']) {
                $cpn = Coupan::where('code', '=', Session::get('coupanapplied')['code'])->first();
            ...
            } elseif ('cart' == Session::get('coupanapplied')['appliedOn']) {
                $cpn = Coupan::where('code', '=', Session::get('coupanapplied')['code'])->first();
    ...
    public function simpeproductincart(Request $request, $pro_id, $price, $offerprice)
    {
        ...
        $t_price = 0 != $offerprice ? $offerprice : $price;
