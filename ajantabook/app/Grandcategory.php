...
class Grandcategory extends Model
{
    ...
    public function getURL()
    {
        ...
        if ($item) {
            ...
            return url('shop?category=' . $item->category->id . '&sid=' . $item->subcategory->id . '&chid=' . $item->id . '&start=' . sprintf('%.2f', $startp * $conversion_rate, 2) . '&end=' . sprintf('%.2f', $endp * $conversion_rate, 2));
        }
