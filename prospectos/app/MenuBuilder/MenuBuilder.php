...
class MenuBuilder
{
    ...
    private function addRegularLink($id, $name, $href, $icon, $iconType, $sequence = 0): void
    {
        $hasIcon = ($icon === false || $icon === '') ? false : true;
        if ($hasIcon) {
    ...
    private function addDropdownLink($id, $name, $href, $icon, $iconType, $sequence = 0): void
    {
        $num = count($this->menu);
        $hasIcon = ($icon === false || $icon === '') ? false : true;
        if ($hasIcon) {
    ...
    public function addLink($id, $name, $href, $icon = false, $iconType = 'coreui', $sequence = 0): void
    {
    ...
    public function addTitle($id, $name, $icon = false, $iconType = 'coreui', $sequence = 0): void
    {
        $hasIcon = ($icon === false || $icon === '') ? false : true;
        if ($hasIcon) {
            array_push($this->menu, [
    ...
    public function beginDropdown($id, $name, $icon = false, $iconType = 'coreui', $sequence = 0): void
    {
        $this->dropdown = true;
        ++$this->dropdownDeep;
        $hasIcon = ($icon === false || $icon === '') ? false : true;
    ...
    public function endDropdown(): void
    {
        --$this->dropdownDeep;
