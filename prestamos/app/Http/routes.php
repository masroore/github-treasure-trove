...
Route::get('dashboard', [
    ...
    function () {
        ...
        for ($i = 1; $i < 14; ++$i) {
            ...
            $amount = 0;
            foreach (\App\Models\Loan::where('branch_id', session('branch_id'))->where('year', $d[0])->where(
                'month',
                $d[1]
            )->whereIn('status', ['disbursed', 'closed', 'written_off'])->get() as $key) {
            ...
            array_push($loans_released_monthly, [
                'month' => date_format(
        ...
        for ($i = 1; $i < 14; ++$i) {
            ...
            $payments = 0;
            $expected = 0;
            foreach (\App\Models\LoanRepayment::where('branch_id', session('branch_id'))->where(
                'year',
                $d[0]
            )->where(
                    'month',
            ...
            foreach (\App\Models\LoanSchedule::where('branch_id', session('branch_id'))->where(
                'year',
                $d[0]
            )->where(
                    'month',
            ...
            $ext = ' ' . $d[0];
            array_push($loan_collections_monthly, [
                'month' => date_format(
                    date_create($start_date2),
                    'M' . $ext
                ),
...
Route::group(['prefix' => 'custom_field'], function (): void {
...
//route for borrowers
Route::group(['prefix' => 'borrower'], function (): void {
...
Route::group(['prefix' => 'guarantor'], function (): void {
...
Route::group(['prefix' => 'update'], function (): void {
...
//route for setting
Route::group(['prefix' => 'setting'], function (): void {
...
//route for loans
Route::group(['prefix' => 'loan'], function (): void {
    //main loan routes
...
//route for tax
Route::group(['prefix' => 'tax'], function (): void {
...
//route for expenses
Route::group(['prefix' => 'expense'], function (): void {
...
Route::group(['prefix' => 'other_income'], function (): void {
...
Route::group(['prefix' => 'collateral'], function (): void {
...
Route::group(['prefix' => 'communication'], function (): void {
...
Route::group(['prefix' => 'client'], function (): void {
...
//route for savings
Route::group(['prefix' => 'saving'], function (): void {
...
//routes for assets
Route::group(['prefix' => 'asset'], function (): void {
...
//route for capital
Route::group(['prefix' => 'capital'], function (): void {
...
//routes branches
Route::group(['prefix' => 'branch'], function (): void {
...
Route::group(['prefix' => 'sms_gateway'], function (): void {
...
Route::group(['prefix' => 'warehouse'], function (): void {
...
//routes for check in
Route::group(['prefix' => 'check_in'], function (): void {
...
Route::group(['prefix' => 'check_out'], function (): void {
...
Route::group(['prefix' => 'chart_of_account'], function (): void {
...
Route::group(['prefix' => 'accounting'], function (): void {
