...
Route::get('dashboard', [
    ...
    function () {
        ...
        for ($i = 1; $i < 14; ++$i) {
            ...
            $expected = 0;
            $principal = 0;
            $actual = $actual + \App\Models\LoanTransaction::where(
                'transaction_type',
                'repayment'
            ...
            foreach (\App\Models\Loan::select(
...
Route::group(['prefix' => 'report'], function (): void {
    ...
    Route::group(['prefix' => 'financial_report'], function (): void {
    ...
    Route::group(['prefix' => 'loan_report'], function (): void {
    ...
    Route::group(['prefix' => 'borrower_report'], function (): void {
    ...
    Route::group(['prefix' => 'company_report'], function (): void {
    ...
    Route::group(['prefix' => 'savings_report'], function (): void {
...
//route for charges
Route::group(['prefix' => 'charge'], function (): void {
