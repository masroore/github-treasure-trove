                           ...
                           <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                 ...
                                 <td align="left" valign="top" style="font-family: 'Poppins', sans-serif; color: #1B9AD6; font-size: 20px; font-weight: 300;">Hey {{ $name }} <span style="display: inline-block;">👋</span><br>
                                    <span style="color: #243F84; font-size: 24px; font-weight: 700; line-height: 40px;">Welcome Back</span>
                                 </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                 ...
                                 <td align="left" valign="top">
                                    <h2 style="color: #000000; font-size: 20px; font-weight: 700; ">Thank you for reactivating on <strong>WhatsPays!</strong></h2>
