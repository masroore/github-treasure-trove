...
class InitialSchema extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('hashes', function (Blueprint $table): void {
            $table->increments('id');
            $table->string('hash');
        ...
        Schema::create('hashables', function (Blueprint $table): void {
            $table->increments('id');
        ...
        Schema::create('category_texts', function (Blueprint $table): void {
            $table->increments('id');
            $table->integer('category_id');
            $table->text('body');
            $table->timestamps();
        });
        Schema::create('task_texts', function (Blueprint $table): void {
            $table->increments('id');
            $table->integer('task_id');
            $table->text('body');
            $table->timestamps();
        ...
        Schema::create('task_subscriber', function (Blueprint $table): void {
            $table->integer('user_id');
            $table->integer('task_id');
            $table->integer('type')->nullable();
            $table->timestamps();
        });
        Schema::create('notifyables', function (Blueprint $table): void {
            $table->increments('id');
        ...
        Schema::create('comentables', function (Blueprint $table): void {
            $table->increments('id');
        ...
        Schema::create('category_subscriber', function (Blueprint $table): void {
            $table->integer('user_id');
            $table->integer('category_id');
            $table->timestamps();
        });
        ...
        Schema::create('user_read_comment', function (Blueprint $table): void {
            $table->integer('user_id');
            $table->integer('comment_id');
            $table->timestamps();
        });
        Schema::create('user_task_option', function (Blueprint $table): void {
            $table->integer('user_id');
            $table->integer('task_id');
            $table->json('commentsstate')->nullable();
            $table->timestamps();
        });
        Schema::create('temp_tasks', function (Blueprint $table): void {
            $table->increments('id');
            $table->integer('task_id');
            $table->integer('user_id');
        ...
        Schema::create('user_unread_activity', function (Blueprint $table): void {
            $table->integer('user_id');
            $table->integer('activity_id');
            $table->timestamps();
        });
        Schema::create('user_task_viewed', function (Blueprint $table): void {
            $table->integer('user_id');
            $table->integer('task_id');
            $table->timestamps();
        });
