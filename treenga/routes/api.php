...
Route::prefix('v1')->group(function (): void {
    ...
    Route::middleware('auth:api')->group(function (): void {
        ...
        //Teams routes
        Route::middleware('update')->prefix('teams')->group(function (): void {
            ...
            Route::prefix('{team}/cats')->group(function (): void {
            ...
            //Team tasks routes
            Route::prefix('{team}/tasks')->group(function (): void {
    ...
    // Admin
    Route::prefix('admin')->namespace('Admin')->group(function (): void {
        Route::post('login', 'AuthController@login');
        Route::middleware('auth:api')->group(function (): void {
